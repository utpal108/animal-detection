...
from animalDetection.entity.config_entity import PrepareBaseModelConfig
...
class PrepareBaseModel:
    ...
    @staticmethod
    def __prepare_full_model(model, classes, freeze_all, freeze_till, learning_rate, dropout_rate):
        if freeze_all:
